...
export default function WorkspaceBuilder (setupTools, makeRootScope) {
  ...
  return function (bundle, deps) {
    ...
    bundle.defineSelector('isWorkspaceLoaded', function (state) {
      return !!state.workspace;
    });

    bundle.defineSelector('isWorkspaceChanged', function (state) {
      return state.unsavedChanges;
    });

    bundle.defineSelector('dumpWorkspace', function (state) {
    ...
    bundle.addReducer('workspaceInitialized', function (state, action) {
      const {task} = state;
      return {
        ...state,
    ...
    bundle.addReducer('taskLoaded', function (state, action) {
    ...
    bundle.defineSelector('WorkspaceSelector', function (state) {

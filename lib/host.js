...
export default function* (deps) {
  ...
  yield addReducer('scoreChanged', function (state, action) {
    return {...state, score: action.score, feedback: action.feedback};
  });
  ...
  remoteActions.feedback = function* (message) {
    const {score, feedback} = message;
    yield put({type: deps.scoreChanged, score, feedback});
    return true;
  };
